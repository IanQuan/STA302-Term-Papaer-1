...
author: 
  - Ian Quan
thanks: "Code and data are available at: https://github.com/IanQuan/STA302-Term-Papaer-1"
date: today
date-format: long
...
Data was cleaned and analyzed using the open source statistically programming language R (@citeR) , using functionalities from tidyverse (@tidyverse), ggplot2 (ggplot), dplyr (dplyr), sf (@sf), sp (@sp) and knitr (knitr). A sample of cleaned data of neighbourhood crime rate in 2023 can be viewed in Table 1.
